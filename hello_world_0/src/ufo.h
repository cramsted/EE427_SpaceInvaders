...
#define UFO_WIDTH (16 * 2)      // pixels wide
#define UFO_HEIGHT (7 * 2)      // pixels tall
#define UFO_SHIFT_X 4           // number of pixels the ufo moves (left or right)
#define UFO_PADDING 8           // border on the left and right edge of the screen
#define UFO_START_X_LEFT UFO_PADDING
#define UFO_START_X_RIGHT (640-UFO_PADDING-UFO_WIDTH)   // subtract the UFO width because X is on the left side of the UFO
